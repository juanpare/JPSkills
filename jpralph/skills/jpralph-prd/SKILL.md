...
Create detailed Product Requirements Documents that are clear, actionable, and suitable for Ralph autonomous implementation.
...
Ralph spawns a fresh context per iteration. If a story is too big, the agent runs out of context before finishing.
